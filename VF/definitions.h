...
object oIDD, oIDU, oT, oNUM, oLI, oLI0, oLI1, oDC, oDC0, oDC1, oSTR, oCHR, oTRUE, oFALSE, oNB, oLV0, oLV1, oID, oLE, oLE0, oLE1, oF0, oF1, oMC, oF, oY0, oY1, oY, oR0, oR1, oR, oL, oL0, oL1, oE0, oE1, oE, oLV, oLP, oLP0, oLP1, oMF, oMT, oME, oMW;
object *p, *t, *f, *t1, *t2, *curFunction, *o, *func;

object int_ = {-1, NULL, SCALAR_TYPE_, 1};
object *pInt = &int_;

object char_ = {-1, NULL, SCALAR_TYPE_, 1};
object *pChar = &char_;

object bool_ = {-1, NULL, SCALAR_TYPE_, 1};
object *pBool = &bool_;

object string_ = {-1, NULL, SCALAR_TYPE_, 1};
object *pString = &string_;

object universal_ = {-1, NULL, SCALAR_TYPE_, 1};
...
void Error(t_error e, int n = 1)
{
    switch(e)
    {
        ...
        case ERR_NOT_DECL:
                        ...
                        break;
        default:
                        printf("Erro desconhecido. Código %d \n", (int)e);
                        break;
    }
}
